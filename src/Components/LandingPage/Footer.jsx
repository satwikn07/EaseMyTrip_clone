            ...
            <footer className={styles.footer}>
                        ...
                        <div className={styles.footer_pay_info}>
                            ...
                            <div className={styles.socialMediaInfo}>
                                ...
                                <div className={styles.icons_div}>
                                    <div><img className={styles.logiImage1} src="https://cdn3.iconfinder.com/data/icons/picons-social/57/06-facebook-512.png" alt="" /> </div>
                                    <div><img className={styles.logiImage2} src="https://cdn.icon-icons.com/icons2/726/PNG/512/TWITTER_icon-icons.com_62686.png" alt="" /></div>
                                    <div><img className={styles.logiImage3} src="https://www.iconpacks.net/icons/1/free-youtube-icon-123-thumb.png" alt="" /></div>
                                    <div><img className={styles.logiImage4} src="https://i.ibb.co/GH5gHRK/367593-48.png" alt="" /></div>
                                    <div><img className={styles.logiImage5} src="https://i.ibb.co/nQyjbQG/1161953-48.png" alt="" /></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className={styles.copyRight_div}>
                    ...
                    <div className={styles.companies_logos}>
                        <img src="https://www.easemytrip.com/images/common/footer-btm-sprite.png" alt="" />
                    </div>
                </div>
            </footer>
        </div>
